...
<html>
<head>
	<title>List Kota | Fw Medika Admin</title>
					...
					<div class="row">
						<div class="col-md-12 text-right">
							<div style="margin-top:20px; margin-bottom:10px;">
								<?php echo anchor(site_url('Kota/tambahKota'),
									'<i class ="fa fa-plus-square" aria-hidden="true"></i> Kota', 'class="btn btn-primary"');
									?>
								</div>
							</div>
						</div>
						<div class="row">
							<table id="example" class="table table-striped table-bordered">
								...
								<tbody>
									<?php foreach ($data_kota as $key => $row) { ?>
									<tr>
										...
										<td>
											<?php 
											echo anchor(site_url('Kota/editKota/'.$row->id_kota), '<i class ="fa fa-pencil"></i>', 'class="btn btn-warning"');
											?>
											<?php 
											echo anchor(site_url('Kota/deleteKota/'.$row->id_kota), '<i class ="fa fa-trash"></i>', 'class="btn btn-danger"');
											?>
										</td>
									</tr>
									<?php } ?>
